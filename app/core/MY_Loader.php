...
/*
		echo $_ci_path;
$_ci_path = file_get_contents($_ci_path);
		...
		else
		{
			...
			/*echo $get_content = str_replace(array(base_url().'images/',base_url().'js/' ),array(config_item('cdn_url_images').'images/',config_item('cdn_url_raw').'js/' ) , eval('?>'.preg_replace("/;*\s*\?>/", "; ?>", str_replace('<?=', '<?php echo ', file_get_contents($_ci_path)))));*/			  
			
			/*
			$get_content = eval('?>'.preg_replace("/;*\s*\?>/", "; ?>", 
									str_replace(
									array(
									...
									array(
									'<?php echo "http://res.cloudinary.com/duidtvpap/raw/upload/js/"; ?>',
									'<?php echo "http://res.cloudinary.com/duidtvpap/raw/upload/js/"; ?>',
									'<?php echo "http://res.cloudinary.com/duidtvpap/raw/upload/js/"; ?>',
									'<?php echo "http://res.cloudinary.com/duidtvpap/raw/upload/js/"; ?>',
									'<?php echo "http://res.cloudinary.com/duidtvpap/images/upload/"; ?>',
									'<?php echo "http://res.cloudinary.com/duidtvpap/images/upload/"; ?>',
									'<?php echo "http://res.cloudinary.com/duidtvpap/images/upload/"; ?>',
									'<?php echo "http://res.cloudinary.com/duidtvpap/images/upload/"; ?>',
									'"http://res.cloudinary.com/duidtvpap/images/upload/"'
									), 
									file_get_contents($_ci_path))));*/
			
						include($_ci_path);
						$currentoutput = ob_get_clean();
						echo str_replace(array(base_url().'images/',base_url().'js/',base_url().'uploads/',base_url().'logo/',base_url().'css/' ),array(cdn_url_images().'images/',cdn_url_raw().'js/',cdn_url_video().'uploads/',cdn_url_logo().'logo/',cdn_url_raw().'css/' ) , $currentoutput ) ;
						flush();
						ob_start();
						/*
							$out = ob_get_clean();
									$out = str_replace(array(base_url().'images/',base_url().'js/' ),array('http://res.cloudinary.com/duidtvpap/images/upload/images/','http://res.cloudinary.com/duidtvpap/raw/upload/js/' ) , $out );
									echo $out ;*/
